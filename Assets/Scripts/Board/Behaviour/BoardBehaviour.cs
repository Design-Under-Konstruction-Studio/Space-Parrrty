    ...
    public class BoardBehaviour : MonoBehaviour
    {
        ...
        private void moveBoardUp()
        {
            if (boardController.boardStatusTypes == BoardStatusTypes.start)
            {
                ...
                GameObject lowerTile = boardController.boardElements[0, boardController.bottomOfBoard - 1];
                GameObject bottomLowerTile = boardController.boardElements[0, boardController.bottomOfBoard];
